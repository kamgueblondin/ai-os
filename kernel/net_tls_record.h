...
typedef struct { const uint8_t* certificate; uint32_t certificate_length; const uint8_t* intermediate; uint32_t intermediate_length; uint32_t certificate_list_length; } net_tls_certificate_view_t;
...
typedef struct { net_tls_handshake_state_t state; uint16_t cipher_suite; const uint8_t* server_random; const uint8_t* server_certificate; uint32_t server_certificate_length; const uint8_t* server_intermediate; uint32_t server_intermediate_length; x509_certificate_view_t server_x509; x509_certificate_view_t server_intermediate_x509; uint8_t server_x509_valid; uint8_t server_intermediate_x509_valid; uint16_t server_named_curve; const uint8_t* server_public_key; uint8_t server_public_key_length; uint8_t certificate_requested; } net_tls_handshake_t;
