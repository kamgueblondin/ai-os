...
def main():
    ...
    say("=== QEMU syscall smoke (sendkey ls/cat/stat/test/alias/export/env/history/jobs/top/date/echo/rc/which/ai/ps/spawn/kill/mkdir/cd/cp/mv/write/touch/append/grep/wc) ===")
