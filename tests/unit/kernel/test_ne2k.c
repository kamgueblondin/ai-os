...
int main(void) {
    ...
    RUN_TEST(test_ne2k_tls_client_start_and_empty_poll);RUN_TEST(test_ne2k_https_llm_request_composes_provider_json_and_bearer);
    unity_print_results();
    unity_cleanup();
