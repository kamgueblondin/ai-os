...
RUN_TEST(test_ne2k_llm_network_context_lifecycle);RUN_TEST(test_ne2k_llm_network_context_sse_resume_lifecycle);RUN_TEST(test_ne2k_llm_network_context_sse_event_tick_persists_retry);RUN_TEST(test_ne2k_socket_poll_tcp_guards);RUN_TEST(test_ne2k_dhcp_renew_if_due_guards_transactionally);RUN_TEST(test_ne2k_llm_connection_acquire_start_dhcp_guard_is_transactional);RUN_TEST(test_ne2k_llm_connection_start_dhcp_guard_is_transactional);
