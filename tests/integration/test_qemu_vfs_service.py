...
def main():
    ...
    with open(ERR, "wb") as err_handle:
        ...
        try:
            ...
            send_command_until(monitor, "vfs-remove fat16/new.txt", "vfsserver remove request", proc)
            ...
            if "NEW.TXT" in log_text()[before_fat16_removed_list:]:
                raise RuntimeError("NEW.TXT reste visible apres vfs-remove FAT16")
