...
> **État réel (août 2026).** Les incréments Foundation 01 à 15 ont livré une boîte aux lettres IPC locale, un médiateur VFS Ring 3, le registre nommé `vfs`, son nettoyage de cycle de vie, une corrélation requête-réponse, un transfert de nom, une conservation FIFO bornée des réponses non corrélées, des sources VFS virtuelles, un backend réservé au propriétaire de `vfs`, sa révocation par transfert, des montages bornés `initrd/ ro` et `overlay/ rw`, des notifications de changement de propriétaire best-effort, une écriture et une suppression VFS corrélées, ainsi que des lectures initrd/overlay source-spécifiques. Voir les notes [IPC](../docs/mohhos_foundation_increment_01_ipc.md), [VFS](../docs/mohhos_foundation_increment_02_vfs_service.md), [registre](../docs/mohhos_foundation_increment_03_service_registry.md), [cycle de vie](../docs/mohhos_foundation_increment_04_service_lifecycle.md), [corrélation](../docs/mohhos_foundation_increment_05_ipc_correlation.md), [transfert](../docs/mohhos_foundation_increment_06_service_grant.md), [différé](../docs/mohhos_foundation_increment_07_ipc_deferred.md), [politique virtuelle](../docs/mohhos_foundation_increment_08_vfs_virtual_policy.md), [backend réservé](../docs/mohhos_foundation_increment_09_vfs_backend.md), [révocation](../docs/mohhos_foundation_increment_10_vfs_revocation.md), [montages](../docs/mohhos_foundation_increment_11_vfs_mounts.md), [notifications](../docs/mohhos_foundation_increment_12_service_notifications.md), [écriture](../docs/mohhos_foundation_increment_13_vfs_write.md), [lectures source-spécifiques](../docs/mohhos_foundation_increment_14_vfs_source_reads.md) et [suppression](../docs/mohhos_foundation_increment_15_vfs_remove.md). Le noyau reste monolithique (`kernel/kernel.c`) : le backend VFS, les pilotes et le réseau n’ont pas encore été déplacés dans des services isolés ; le registre ne délivre ni capability ni identité vérifiée, les événements ne sont pas accusés et les mutations VFS ne sont pas transactionnelles. Les critères complets de microkernel ci-dessous restent à réaliser. Runtime : [../docs/ETAT_REEL.md](../docs/ETAT_REEL.md).
