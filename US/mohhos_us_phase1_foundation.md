...
> **État réel (août 2026).** Les incréments Foundation 01 à 06 ont livré une boîte aux lettres IPC locale, un médiateur VFS Ring 3, le registre nommé `vfs`, son nettoyage de cycle de vie, une corrélation requête-réponse locale et un transfert limité de nom ; voir les notes [IPC](../docs/mohhos_foundation_increment_01_ipc.md), [VFS](../docs/mohhos_foundation_increment_02_vfs_service.md), [registre](../docs/mohhos_foundation_increment_03_service_registry.md), [cycle de vie](../docs/mohhos_foundation_increment_04_service_lifecycle.md), [corrélation](../docs/mohhos_foundation_increment_05_ipc_correlation.md) et [transfert](../docs/mohhos_foundation_increment_06_service_grant.md). Le noyau reste monolithique (`kernel/kernel.c`) : le backend VFS, les pilotes et le réseau n’ont pas encore été déplacés dans des services isolés, le registre ne délivre aucune capability, aucune révocation et le client ne conserve pas les réponses IPC non corrélées. Les critères complets de microkernel ci-dessous restent à réaliser. Runtime : [../docs/ETAT_REEL.md](../docs/ETAT_REEL.md).
