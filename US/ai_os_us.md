...
| AOS-012 | Prevenir les regressions | 496 tests C et contrats QEMU versionnes, dont `qemu-ne2k-status`, `qemu-ne2k-acquire`, `qemu-ne2k-tls-http`, `qemu-ne2k-tls-sse` et `qemu-vfs-service` |
...
**Verification.** `make qemu-ai-provider`, `make qemu-ne2k-status`, `make qemu-ne2k-acquire`, `make qemu-ne2k-tls-http` et `make qemu-ne2k-tls-sse`.
