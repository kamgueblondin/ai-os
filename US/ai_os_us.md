...
|---|---|---|
| 0 | Budget CI QEMU | Conserver les sept contrats séquentiels sous 25 minutes et le smoke multi-pairs dans GitHub Actions, sans retirer d’assertion métier ni rejouer une mutation ou I/O incertaine ; la dernière mesure locale est 787,6 s |
| 1 | Granularité backend par préfixe | Évaluer une ACL noyau par préfixe à l’intérieur d’une source ; le scope actuel de source entière, désormais observable pendant une transaction, ne doit pas être présenté comme une capability chemin |
