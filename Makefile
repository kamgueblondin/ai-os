...
build/net_tls_record.o: kernel/net_tls_record.c kernel/net_tls_record.h kernel/aes_gcm.h kernel/x509_der.h kernel/rsa_verify.h
	@mkdir -p $(dir $@)
	$(CC) $(CFLAGS) -c $< -o $@
