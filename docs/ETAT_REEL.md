...
| IPC/VFS Foundation MOHHOS | Boîte aux lettres FIFO non bloquante entre tâches Ring 3, 4 entrées par tâche, charge de 96 octets et `request_id` corrélé ; médiateur VFS, sources virtuelles, compteurs volatils et table de montages locale bornée avec alias initrd/overlay dynamiques |
