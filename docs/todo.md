...
- [x] Lot TLS/HTTP local : ancre de test `api.example.test`, pair QEMU `0xc02f` + X25519 + RSA/SHA-256, `TLS_COMPLETE`, POST ollama et HTTP 200 JSON ; `make qemu-ne2k-tls-http` ; pas d'hote public ni d'OpenAI
