...
| Réseau | Pilote NE2000 ISA, `SYS_NET_STATUS`, codecs ARP/IPv4/UDP/DHCP/DNS/TCP/TLS record et registre TCP statique exposé par six syscalls socket ; validation des pointeurs utilisateur, HTTP/TLS LLM et OpenAI restent à intégrer |
