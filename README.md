...
| `make integration-qemu` | Sept contrats QEMU AOS-022, AOS-024, AOS-025, NE2000, IPC, VFS avec montages dynamiques, mutations médiées, révocation, notifications, cycle de vie et transfert Foundation ; validation locale mesurée à 416,8 s sans assertion retirée |
...
- [x] Ramener `make integration-qemu` sous 25 minutes sans relâcher les assertions métier : sept contrats complets en 6 min 57 s en validation locale
...
- [ ] Externaliser optionnellement les I/O des alias VFS au worker Ring 3, avec droits minimaux et corrélation conservée ; l’autorité add/remove et les répertoires sont déjà livrés
