...
| Fichiers | Archive initrd TAR en lecture seule, overlay AIOV V2 sur ATA PIO (64 nœuds, V1 compatible), transferts sectoriels x86 `rep insw`/`rep outsw`, volume FAT16 et primitives FAT32 d’écriture/chaînage/rollback hors intégration VFS complète |
...
| `make test-all` | Suite complète Unity/robustesse ; l’état courant validé est de 457 tests exécutés avec succès |
