...
| Utilisateur | Shell ELF Ring 3, ABI de syscalls 0-125 (`MAX_SYSCALLS = 126`), `spawn`, `yield`, `exec`, `ps`, `kill` |
...
| `make test-all` | Suite complète Unity/robustesse ; l’état validé courant est de 510 tests exécutés avec succès |
