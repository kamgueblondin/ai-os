...
| `make test-all` | Suite complète Unity/robustesse ; l’état validé est de 489 tests exécutés avec succès |
...
| `make qemu-vfs-service` | Lance `vfsvirtual` puis `vfsserver`, vérifie la délégation Ring 3, les volumes FAT16/FAT32 réels sur deux disques IDE, les alias dynamiques, les capacités, les refus, les mutations overlay et le cycle FAT16 création/lecture/renommage/listage/suppression sous `mutate` |
