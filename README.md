...
- [~] Migration microkernel réelle : première délégation `vfsserver` → `vfsvirtual` Ring 3 livrée pour `vfs-info` ; backend de stockage processus séparé et transferts de données hors du noyau encore ouverts
